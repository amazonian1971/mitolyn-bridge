...
export default function Home() {
  ...
  const faqs = [
    ...
    { question: "How long until I see results?", answer: "Many users report feeling a noticeable difference in their energy levels within the first two weeks of consistent daily use. For best results, we recommend a 3-month course to allow the ingredients to work synergistically with your body." },
    { question: "Do I need to change my diet or exercise?", answer: "No special diet is required. Mitolyn is designed to complement your existing lifestyle. However, combining it with a balanced diet and regular activity will naturally enhance your results." },
    { question: "What if it doesn't work for me?", answer: "We are confident you'll love Mitolyn, but if for any reason you're not satisfied, you're covered by our 60-day, no-questions-asked, money-back guarantee." },
    { question: "What are the ingredients in Mitolyn?", answer: "Mitolyn contains a proprietary blend of natural ingredients, including green tea extract for metabolism, B-vitamins for energy production, and other potent compounds that support mitochondrial health." }
  ];

  const features = [ "Boosts Natural Energy", "Supports Healthy Metabolism", "Reduces Afternoon Slumps", "Stimulant-Free Formula", "No Jitters or Crashes", "Made in the USA" ];
    ...
    <div className={`${inter.variable} ${lora.variable} font-sans bg-stone-50 text-gray-800`}>
        ...
        <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
                <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-xl font-semibold mb-2">Nourishes Mitochondria</h3>
                    <p className="text-gray-600">Supports the "powerhouses" of your cells for efficient energy production.</p>
                </div>
                <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-xl font-semibold mb-2">Balances Metabolism</h3>
                    <p className="text-gray-600">A gentle, stimulant-free formula to complement your body's metabolic rhythm.</p>
                </div>
                <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-xl font-semibold mb-2">Sustains Vitality</h3>
                    <p className="text-gray-600">Promotes all-day energy and mental clarity without the dreaded crash.</p>
                </div>
            </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="md:order-1">
            <h2 className={`font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-6 ${lora.className}`}>
              Energy That Moves You. Awaken Your Metabolic Potential.
            </h2>
            <p className="text-lg text-gray-600 mb-8">Feel the Mitolyn difference with a formula crafted for peace of mind.</p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4">
            <div className="bg-stone-100 border border-stone-200 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
                ...
                <div>
                    <h2 className={`font-serif text-3xl font-bold text-gray-900 mb-3 ${lora.className}`}>Our 60-Day "Feel The Difference" Guarantee</h2>
                    <p className="text-lg text-gray-600">Try Mitolyn for a full 60 days. If you don't feel a remarkable improvement in your energy and vitality, simply contact us for a full refund. No questions, no hassles. Your journey to feeling great is completely risk-free.</p>
                </div>
            </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-gradient-to-br from-emerald-600 to-teal-700 text-white">
        <div className="max-w-3xl mx-auto text-center px-4">
          <h2 className={`font-serif text-4xl md:text-5xl font-bold mb-6 ${lora.className}`}>Ready to Feel Like Yourself Again?</h2>
          <p className="text-xl text-emerald-100 mb-10">
            Click the button below to get started. Your secure sign-in with Google takes less than 30 seconds.
          </p>
          <button
            onClick={() => signIn("google")}
            disabled={loading}
          ...
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" /><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" /><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z" /><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" /></svg>
            <span>Claim My Risk-Free Offer</span>
            <span>→</span>
          </button>
      ...
      {showStickyBar && (
        <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-gray-200 shadow-2xl z-50 animate-in slide-in-from-bottom duration-300">
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
            <div>
              <p className="font-bold text-gray-900 hidden sm:block">Ready to Reclaim Your Spark?</p>
              <p className="text-sm text-gray-600">Your risk-free offer is waiting.</p>
            </div>
            <button
              onClick={() => signIn("google")}
              disabled={loading}
